...
type ForgeKontaktReachSocialProps = {
...
export function ForgeKontaktReachSocial({ links }: ForgeKontaktReachSocialProps) {
  ...
  return (
    <div className="ms-forge-kontakt-reach-socials" aria-label="Social Media">
      {items.map(({ key, href, label, icon }) => (
        <a
          ...
          className="ms-forge-kontakt-reach-social-btn"
          aria-label={label}
          title={label}
        >
          {icon}
